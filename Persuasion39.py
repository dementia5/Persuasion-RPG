...
motive_descriptions = {
    "Fanaticism": "Eyes burn with a wild, unyielding light, as if some hidden truth in the darkness is visible to only one. Hands tremble with fervor, clutching at a pendant or prayer beads for protection—or power. A mind teeters on the edge of devotion and madness.",
    "Revenge": "A simmering anger lurks beneath a calm exterior, every word edged with old wounds and bitter memory. Gaze flickers with resentment, and the past is never forgotten. The air feels charged, as if violence is never far from thought.",
    "Jealousy": "A brittle smile and darting glances reveal longing and spite. Every gesture is calculated, measuring against invisible rivals. Envy gnaws at the heart, desperate for recognition.",
    "Forbidden Love": "A haunted tenderness lingers in every expression, shadowed by guilt and longing. Speech comes in half-truths, secrets aching to be confessed. A soul is torn between passion and peril.",
    "Desperation": "Movements are restless, words tinged with anxiety and pleading. The weight of debts and failures presses down, driving ever closer to the edge. Every glance searches for escape—or salvation.",
    "Ambition": "A calculated poise and searching eyes betray a hunger for advantage. Words are smooth, but power lurks beneath the surface. Nothing stands in the way of ascent.",
    "Obsession": "A distant gaze fixes on patterns unseen by others. Muttered words piece together mysteries that may not exist. The mind is consumed by a single, all-devouring purpose.",
    "Fear": "A flinch at every sound, wide and haunted eyes, and a quivering voice betray terror. Sweat beads on the brow, and panic is sharp in the air. Terror drives every action—of secrets, discovery, or something unseen.",
    "Blackmail": "Guarded words are weighed and measured, calculation flickering in every glance. Every conversation is a careful negotiation. Secrets are both weapon and shackle.",
    "Guilt": "Shoulders sag beneath an invisible burden, and eyes avoid contact. Words come slowly, each a confession. The soul is haunted by past misdeeds.",
    "Loyalty": "Conviction rings in every word, loyalty to another evident in every action. Yet a tension lingers, torn between duty and conscience. Any sacrifice would be made to protect what is cherished.",
    "Resentment": "A clipped tone and curt answers reveal simmering old grievances. Every interaction is colored by bitterness. A grudge has festered for years.",
    "Zealotry": "Faith stands absolute, certainty unshakeable. Speech is delivered as if on a mission ordained by higher powers. A dangerous righteousness is present, blind to doubt or mercy.",
    "Shame": "Averted gaze and flushed cheeks betray embarrassment. Words are evasive, desperate to hide some personal failing. A secret corrodes from within.",
    "Manipulation": "A sly smile plays at the lips, and eyes never quite meet another's. Every answer is rehearsed, every gesture calculated. Deception is an art, and the game is always deeper than it appears."
}
...
motive_flavor_texts = {
    "Fanaticism": {
        "Male": [
            "His eyes burn with a wild, unyielding light, as if he alone can see some hidden truth writhing in the darkness beyond mortal sight. His hands tremble with fervor, clutching at a pendant or prayer beads as if for protection—or power. You sense that his faith is not a comfort, but a fever that gnaws at the edges of sanity.",
            "He mutters prayers under his breath, each syllable a ward against horrors only he perceives. The air around him feels charged, as if unseen forces gather at his command. There is a brittle edge to his devotion, a sense that he would burn the world to keep his beliefs intact."
        ],
        "Female": [
            "Her gaze burns with zeal, and her words tumble out in a feverish rush, each one a desperate plea to unseen gods. She clings to her faith with a grip so tight it threatens to draw blood, blind to doubt or mercy. In her presence, the air grows heavy, as if ancient rites are being whispered just beyond the veil.",
            "Her hands twist a rosary as she speaks, the beads worn smooth by countless anxious prayers. Shadows seem to gather at her feet, drawn by the intensity of her conviction. You sense that her piety is a shield against terrors that would shatter a lesser mind."
        ]
    },
    "Revenge": {
        "Male": [
            "A simmering anger lurks beneath his calm exterior, every word edged with old wounds and bitter memory. His gaze flickers with resentment, as if he sees ghosts of past betrayals in every shadow. The air around him crackles with the promise of violence, and you sense he would wait a lifetime to see justice—or vengeance—done.",
            "He carries himself with a simmering anger, every movement deliberate and tense, as if waiting for a chance to strike back. His voice is low and measured, but you hear the grinding of old grudges in every syllable. There is a darkness in him that time has not healed, only deepened."
        ],
        "Female": [
            "Her voice trembles with restrained fury, and her eyes never quite meet yours, as if she fears what might spill out if she lets her guard down. She moves with a quiet intensity, plotting retribution with every breath, her heart a ledger of ancient wrongs. In her presence, you feel the weight of unfinished business, as if the past itself demands blood.",
            "She speaks softly, but her words are sharp as knives, each syllable honed by years of bitterness. The room seems colder when she enters, as if the warmth of forgiveness cannot survive her presence. You sense that her need for revenge is a hunger that will never be sated."
        ]
    },
    "Jealousy": {
        "Male": [
            "His eyes flicker with envy, every gesture betraying a longing for what he cannot have, and a bitterness that festers in the soul. He measures himself against others with every glance, his pride wounded by every slight, real or imagined. There is a restless energy about him, as if he is forever chasing shadows that dance just out of reach.",
            "He laughs too loudly, as if to drown out the gnawing ache of being overlooked, his mirth brittle and forced. The air around him is thick with unspoken comparisons, and you sense that every compliment is a veiled accusation. His jealousy is a living thing, coiling tighter with every passing moment."
        ],
        "Female": [
            "Her smile is brittle, her gaze lingering on others with a mixture of longing and spite, as if she weighs every word and gesture for hidden meaning. Every movement seems calculated, a subtle dance of rivalry and resentment. In her presence, you feel the chill of old grudges, and the sense that she would see the world burn rather than be left behind.",
            "She watches you with a sidelong glance, her words tinged with a subtle bitterness that seeps into the conversation like poison. The room feels smaller when she is near, as if her envy draws the walls inward. You sense that her heart is a battlefield, and every victory is pyrrhic."
        ]
    },
    "Forbidden Love": {
        "Male": [
            "A haunted tenderness lingers in his expression, shadowed by guilt and longing, as if he carries a secret too heavy for mortal shoulders. He speaks in half-truths, guarding secrets that ache to be confessed, his words trembling on the edge of revelation. You sense a soul torn between passion and peril, haunted by the specter of a love that defies the natural order.",
            "He avoids your gaze, his words heavy with unspoken affection and regret, as if the very air conspires to keep his secrets. The silence between his sentences is thick with meaning, and you feel the presence of another, unseen but ever near. His heart is a labyrinth, and at its center lies a forbidden flame."
        ],
        "Female": [
            "A haunted tenderness lingers in her expression, shadowed by guilt and longing, as if she is pursued by memories that will not fade. She speaks in half-truths, guarding secrets that ache to be confessed, her voice trembling with the weight of forbidden desire. In her presence, you feel the pull of unseen tides, drawing her ever closer to the edge of ruin.",
            "She blushes at the mention of certain names, her voice faltering as she tries to hide her feelings, but the truth glimmers in her eyes. The air around her is charged with longing, and you sense that her love is both a blessing and a curse. She is a moth drawn to a flame, knowing it will consume her, yet unable to turn away."
        ]
    },
    "Desperation": {
        "Male": [
            "His movements are restless, his words tinged with anxiety and a hint of pleading, as if he is forever on the verge of flight. You see the weight of debts and failures pressing down on him, driving him to the edge of reason. There is a wildness in his eyes, a sense that he would do anything—anything—to escape the jaws of fate.",
            "He glances around nervously, as if searching for an escape route that isn't there, his breath coming in shallow gasps. The room seems to close in on him, and you sense that he is hunted by more than just his own conscience. Desperation clings to him like a second skin, cold and unyielding."
        ],
        "Female": [
            "Her hands fidget constantly, and her voice is edged with panic, as if she is drowning in a sea of unseen dangers. She seems cornered by circumstances beyond her control, her every word a plea for mercy from an indifferent universe. In her presence, you feel the press of invisible walls, and the certainty that she is running out of time.",
            "She wrings her hands, her eyes darting to the door as if longing to flee, but finding no refuge. The air around her is thick with the scent of fear, and you sense that she is one step away from unraveling. Desperation is her only companion, and it whispers terrible things in the dark."
        ]
    },
    "Ambition": {
        "Male": [
            "He carries himself with calculated poise, eyes always searching for advantage, as if the world is a chessboard and he its master. His words are smooth, but you sense a hunger for power lurking beneath, a hunger that will not be denied. In his presence, you feel the inexorable pull of destiny, and the chill of a soul willing to sacrifice all for a taste of greatness.",
            "He smiles with practiced ease, but his gaze is sharp and appraising, measuring your worth in secrets and opportunities. The air around him crackles with potential, and you sense that he is always three moves ahead. Ambition is his lodestar, and he will follow it into the abyss."
        ],
        "Female": [
            "She stands tall, her posture radiating confidence, every word chosen with care, each gesture a step toward her goals. Her eyes gleam with determination, and her compliments feel like veiled challenges, as if every kindness is a test. In her presence, you sense the weight of unspoken plans, and the certainty that she will not be denied her due.",
            "Her ambition is a living thing, coiling around her like a serpent, whispering of glory and ruin in equal measure. The room seems brighter when she enters, as if the very air bends to her will. She is a force of nature, and woe to those who stand in her way."
        ]
    },
    "Obsession": {
        "Male": [
            "His gaze is distant, fixed on patterns only he can see, as if the world is a puzzle he alone must solve. He mutters to himself, piecing together mysteries that may not exist, his fingers tracing invisible lines in the air. Obsession has hollowed him out, leaving only the hunger for answers that may never come.",
            "He clutches a worn notebook, scribbling frantic notes even as you speak, his attention flickering between you and some unseen calculus. The air around him is thick with the scent of ink and desperation, and you sense that he is haunted by questions that have no answers. His mind is a labyrinth, and he is both prisoner and warden."
        ],
        "Female": [
            "Her fingers trace invisible lines in the air, her thoughts clearly elsewhere, as if she is haunted by visions only she can see. She is consumed by a single, all-devouring purpose, her every word a step along a path that leads ever deeper into darkness. In her presence, you feel the pull of the unknown, and the certainty that some doors should remain closed.",
            "She speaks in circles, returning again and again to the same subject, unable to let go, her voice rising and falling like the tide. The room seems to pulse with her need, and you sense that she would sacrifice anything for a glimpse of forbidden truth. Obsession is her master, and she its willing servant."
        ]
    },
    "Fear": {
        "Male": [
            "He flinches at every sound, eyes wide and haunted, as if he is pursued by terrors that lurk just beyond the edge of sight. His voice quivers, and sweat beads on his brow, the scent of panic sharp in the air. You sense that his fear is not merely of the present, but of memories that gnaw at his soul.",
            "He glances over his shoulder constantly, as if expecting danger at any moment, his hands trembling with the effort of holding himself together. The room feels colder when he is near, as if the shadows themselves are drawn to his dread. Fear is his constant companion, and it whispers of doom in the darkness."
        ],
        "Female": [
            "She shrinks from your gaze, her words barely above a whisper, as if she fears that even the walls have ears. Fear clings to her like a second skin, her every movement a study in caution and regret. In her presence, you feel the weight of unseen eyes, and the certainty that something terrible waits just out of sight.",
            "Her hands tremble as she speaks, and she seems desperate to avoid your questions, her gaze darting to every corner of the room. The air around her is thick with the scent of old nightmares, and you sense that she is haunted by things best left unspoken. Fear has hollowed her out, leaving only the shell of what once was."
        ]
    },
    "Blackmail": {
        "Male": [
            "He is guarded, every word weighed and measured, as if he walks a tightrope above a pit of secrets. His eyes flicker with calculation, always considering what you know—and what you might reveal. The air around him is thick with unspoken threats, and you sense that he is both jailer and prisoner of his own machinations.",
            "He offers a tight-lipped smile, his secrets hidden behind a wall of caution, his laughter forced and brittle. The room feels smaller when he is near, as if the walls themselves are closing in. Blackmail is a game he plays well, but you sense that the stakes are higher than he lets on."
        ],
        "Female": [
            "She chooses her words carefully, her gaze sharp and assessing, as if every conversation is a negotiation. You sense she is always listening for what you don't say, her mind a web of secrets and lies. In her presence, you feel the tug of invisible strings, and the certainty that you are not the only one being played.",
            "Her laughter is forced, and she changes the subject whenever you press too closely, her smile never quite reaching her eyes. The air around her is thick with the scent of old scandals, and you sense that she is both hunter and hunted. Blackmail is her currency, and she spends it with ruthless precision."
        ]
    },
    "Guilt": {
        "Male": [
            "His shoulders sag beneath an invisible burden, and his eyes avoid yours, as if he is haunted by ghosts only he can see. Words come slowly, each one a confession dragged from the depths of regret. The air around him is heavy with sorrow, and you sense that he is drowning in memories he cannot escape.",
            "He sighs often, his voice heavy with regret, the sound lingering in the silence like a funeral bell. The room feels colder when he is near, as if his guilt draws the warmth from the world. Guilt is his shadow, and it clings to him with relentless devotion."
        ],
        "Female": [
            "She bites her lip, her gaze fixed on the floor, each answer seeming to cost her dearly. She fidgets with her hands, her voice wavering as she struggles to maintain composure, the weight of her secrets pressing down on her. In her presence, you feel the ache of old wounds, and the certainty that some sins can never be forgiven.",
            "Her eyes glisten with unshed tears, and her voice trembles with regret, the sound barely more than a whisper. The air around her is thick with the scent of loss, and you sense that she is haunted by what might have been. Guilt is her constant companion, and it will not let her rest."
        ]
    },
    "Loyalty": {
        "Male": [
            "He stands like a sentinel, his devotion to another etched in every line of his face. His words are measured, but you sense a storm of conflict beneath the surface. Loyalty binds him tighter than chains, and he would walk willingly into darkness for those he serves."
        ],
        "Female": [
            "Her eyes shine with unwavering devotion, yet a shadow of doubt flickers when she thinks herself unseen. She speaks of duty and love as if they are one and the same, her voice trembling with the weight of sacrifice. Loyalty is her guiding star, but it may yet lead her astray."
        ]
    },
    "Resentment": {
        "Male": [
            "His tone is clipped, his answers curt, as if every word is a stone thrown at unseen enemies. Old grievances simmer just beneath the surface, coloring every interaction with a bitter hue. You sense a grudge that has festered for years, poisoning his soul."
        ],
        "Female": [
            "She crosses her arms defensively, her words laced with sarcasm and old pain. Resentment radiates from her in waves, warping the air with its intensity. She is a vessel for ancient wounds, and her heart is a battlefield where forgiveness has long since fled."
        ]
    },
    "Zealotry": {
        "Male": [
            "His faith is absolute, his certainty unshakeable, as if he walks in the shadow of some ancient and terrible god. He speaks as if on a mission ordained by higher powers, his voice ringing with the cold music of prophecy. You sense a dangerous righteousness, blind to doubt or mercy, and wonder what horrors he would unleash in the name of salvation."
        ],
        "Female": [
            "Her faith radiates from her like a fever, burning away all hesitation and mercy. She speaks in tongues, her voice rising and falling in a cadence that chills the blood. You sense that she would walk willingly into the abyss, certain that her god waits on the other side."
        ]
    },
    "Shame": {
        "Male": [
            "He shrinks from your gaze, cheeks flushed with embarrassment, as if the weight of his own failings is too much to bear. His words are evasive, and he seems desperate to hide some personal failing that gnaws at his soul. Shame clings to him like a shroud, suffocating and cold."
        ],
        "Female": [
            "She lowers her eyes, her cheeks tinged with red, her voice barely more than a whisper. Every answer is a dance around the truth, and you sense a secret that corrodes from within. Shame is her constant companion, a silent specter at her side."
        ]
    },
    "Manipulation": {
        "Male": [
            "A sly smile plays at his lips, and his eyes never quite meet yours, as if he is always calculating the next move. Every answer feels rehearsed, every gesture calculated to draw you deeper into his web. You sense a master of deception, always playing a deeper game, his true intentions hidden beneath layers of charm."
        ],
        "Female": [
            "Her laughter is light, but her eyes are sharp, watching for every weakness. She steers the conversation with practiced ease, her words weaving a tapestry of half-truths and insinuations. Manipulation is her art, and you are but a pawn on her board."
        ]
    },
    "Greed": {
        "Male": [
            "His gaze lingers on every object of value, his fingers twitching with the urge to possess. He speaks of opportunity and gain, his voice thick with longing for wealth and power. Greed has hollowed him out, leaving only the hunger for more."
        ],
        "Female": [
            "Her eyes sparkle at the mention of riches, and she is quick to notice anything of value. She talks of fortunes won and lost, her ambition for more always apparent. Greed is her lodestar, and she would barter anything for a taste of gold."
        ]
    },
    "Remorse": {
        "Male": [
            "He sighs deeply, haunted by memories he cannot escape, his eyes clouded with sorrow. His words are tinged with regret, each syllable a plea for forgiveness that may never come. Remorse is a chain around his heart, dragging him ever backward into the shadows of the past."
        ],
        "Female": [
            "Her eyes glisten with unshed tears, and her voice trembles with regret, the sound barely more than a whisper. She speaks of the past with a heavy heart, desperate to right old wrongs. Remorse is her constant companion, a ghost that will not be laid to rest."
        ]
    },
    "Hatred": {
        "Male": [
            "His jaw clenches at the mention of certain names, and his words drip with venom. He glares at you, his anger barely contained beneath a thin veneer of civility. Hatred burns in him like a black flame, consuming all reason."
        ],
        "Female": [
            "Her tone is icy, her words sharp as daggers, and she does not bother to hide her contempt. She scoffs at your questions, her hatred simmering just below the surface. In her presence, the air grows cold and brittle, as if love itself has been banished."
        ]
    },
    "Duty": {
        "Male": [
            "He stands tall, his posture rigid with a sense of responsibility, every word weighed with the burden of obligation. He speaks of honor and service, his sense of duty unwavering even as it leads him into darkness. Duty is his compass, but it may yet steer him astray."
        ],
        "Female": [
            "Her answers are precise, her demeanor formal, as if she carries the weight of the world on her shoulders. She is determined to fulfill her obligations, no matter the cost. Duty is her shield, but it may also be her prison."
        ]
    },
    "Curiosity": {
        "Male": [
            "His eyes dart around the room, hungry for new information, as if every secret is a morsel to be devoured. He asks as many questions as he answers, his mind a labyrinth of speculation and wonder. Curiosity is his curse, driving him ever deeper into forbidden knowledge."
        ],
        "Female": [
            "She listens intently, her curiosity evident in every question she asks, her gaze sharp and inquisitive. She is drawn to mysteries like a moth to flame, heedless of the danger. Curiosity is her guiding star, but it may yet lead her to ruin."
        ]
    },
    "Ambivalence": {
        "Male": [
            "He hesitates before answering, his thoughts clearly divided, as if he is a stranger to his own heart. He seems unsure of his own motives, his loyalties shifting like sand. Ambivalence is a fog that clouds his every step."
        ],
        "Female": [
            "She wavers in her responses, torn between conflicting loyalties, her words trailing off into silence. Her indecision is clear, her answers shifting with the wind. Ambivalence is her shadow, always at her heels."
        ]
    },
    "Pride": {
        "Male": [
            "He holds his head high, his confidence bordering on arrogance, as if the world itself owes him tribute. He bristles at any suggestion of fault, his pride easily wounded. Pride is his armor, but it may also be his downfall."
        ],
        "Female": [
            "She speaks with authority, her self-assurance unshakable, her gaze daring you to challenge her. She dismisses criticism with a wave, her pride a shield against doubt. Pride is her crown, but it may yet become a yoke."
        ]
    },
    "Despair": {
        "Male": [
            "His shoulders slump, and his eyes are hollow, as if hope has long since abandoned him. He speaks as if the world is a tomb, his words heavy with resignation. Despair is a weight that drags him ever downward."
        ],
        "Female": [
            "Her voice is flat, her gaze distant, as if she is lost in a fog of hopelessness. She barely responds, her spirit weighed down by sorrow. Despair is her only companion, and it whispers of oblivion."
        ]
    },
    "Envy": {
        "Male": [
            "He watches others with a covetous gaze, his envy barely concealed beneath a mask of civility. He grumbles about what he lacks, his resentment clear in every word. Envy is a poison that seeps into his soul, corroding all joy."
        ],
        "Female": [
            "She compares herself to others constantly, her envy coloring every word and gesture. She sighs wistfully, longing for what she cannot have. Envy is a hunger that can never be sated."
        ]
    }
}
...
witnesses_pool = [
    "Was seen by the maid.",
    "Claims to have been alone.",
    "Saw another suspect nearby.",
    "No one can confirm their whereabouts.",
    "Was with a group in the parlor.",
    "Claims the butler saw them.",
    "Was seen by the gardener.",
    "Says the cook can vouch for them."
]

financial_pool = [
    "He owed me a great deal of money.",
    "I have no interest in his wealth.",
    "I needed the Bishop's inheritance.",
    "I am not motivated by money.",
    "I was desperate for funds.",
    "I am well-off and had no financial motive.",
    "I lost a fortune in the war.",
    "I was promised a generous donation."
]

secret_relationship_pool = [
    "We were lovers.",
    "He threatened to expose my secret.",
    "We shared a forbidden bond.",
    "There was nothing between us.",
    "He was like family to me.",
    "We had a professional relationship only.",
    "He was my mentor.",
    "We quarreled over a personal matter."
]

blackmail_pool = [
    "The Bishop was hiding something far worse than you know.",
    "Secrets are dangerous in this house.",
    "I know nothing of blackmail.",
    "He was being threatened by someone.",
    "I warned him about his secrets.",
    "Blackmail is a dangerous game.",
    "He confided in me about a blackmailer.",
    "I received an anonymous threat as well."
]

confession_pool = [
    "I would never harm the Bishop!",
    "You have no proof!",
    "Fine, I admit it!",
    "This is absurd!",
    "I am innocent!",
...
def deduction_tree_for_suspect(suspect_name):
    ...
    if suspect.get("opportunity"):
        print("├─ ✓ Had the opportunity to commit the crime.")
    else:
        print("├─ ✗ No opportunity to commit the crime.")
...
def case_resolution():
    ...
    if len(game_state["clues"]) >= game_state.get("required_clues", 5):
        ...
        if accused.get("is_murderer"):
            ...
            # After solving the case, before adding the Eidon quest:
            ...
            # Check for pages
            required_pages = {
                "First Fragment of the Eidon Manuscript",
                "Second Fragment of the Eidon Manuscript",
                "Third Fragment of the Eidon Manuscript"
            }
            player_pages = set(item for item in game_state["inventory"] if "Fragment of the Eidon Manuscript" in item)
            if required_pages.issubset(player_pages):
                ...
                quest_text = "Assemble the Book of Eidon by finding all three manuscript fragments."
    ...
    while True:
        ...
        if user_input.isdigit():
            ...
            if 0 <= idx < len(suspects_here):
                ...
                # delay_print(f"{YELLOW}{suspect['motive_long']}{RESET}") DEBUG on motive
                ...
                while True:
                    ...
                    if choice == "1":
                        ...
                        if confession == "Fine, I admit it!":
                            delay_print(f"{ORANGE}{suspect['name']} has confessed!{RESET}")
                            accused = suspect
                            crime = game_state.get("crime_type", "disappearance")
                            delay_print(f"{YELLOW}You accuse {accused['name']}... and the evidence is overwhelming! The culprit breaks down and confesses!{RESET}")
                            if crime == "murder":
